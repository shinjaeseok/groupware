        ...
        var oTable = $("#dataTables_1").DataTable({
            ...
            columns: [
                ...
                { data: "id" , render : function ( data, type, row, meta ) {
                        return `<button class="btn btn-xs btn-default waves-effect waves-themed btn_update" onclick="btn_detail('${data}')">상세보기</button>`;
                    }},
                @endif
            ],
            buttons: [
