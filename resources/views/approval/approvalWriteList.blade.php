                ...
                <div class="ibox-content">
                    ...
                    <div class="tabs-container">
                        <ul class="nav nav-tabs" id="myTab-01" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="approval-tab-04" data-toggle="tab" href="#dataTables_approval-04" role="tab" aria-controls="approval-04" aria-selected="false">
                                    반려</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show" id="dataTables_approval-04" role="tabpanel" aria-labelledby="approval-tab-04">
                                <div class="table-responsive">
                                    <table class="table mb-0" id="dataTables_4" style="width: 100%">
                                        <colgroup>
                                            <col style="width: 70px;">
                                            <col style="width: 150px;">
                                            <col style="width: 150px;">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-lg-12 float-e-margins">
                            <button type="button" class="btn btn-w-sm btn-warning btn-sm" id="btn_approval_retrieve">회수</button>
...
@section('script')
    @include('approval.approvalWriteList_js')
@endsection
