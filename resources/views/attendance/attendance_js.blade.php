<script>
    ...
    function doSearch() {
        ...
        var oTable = $("#dataTables_1").DataTable({
            ...
            columns: [
                ...
                { data: "status" , class: "", orderable: false},
                { data: "id", orderable: false , render : function ( data, type, row, meta ) {
                        return `<button class="btn btn-xs btn-default btn_update" onclick="btn_edit('${data}')">수정 요청</button>`;
                    }},
            ],
            buttons: [
            ],
    ...
    $("#btn_save").click(function () {
        ...
        if(!$("#modal_work_start_time_after").val() && !$("#modal_work_end_time_after").val()) {
